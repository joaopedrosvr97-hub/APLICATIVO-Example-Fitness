      ...
      try {
        ...
        if (params.sessionToken) {
          ...
          if (Platform.OS === "web") {
            ...
            console.log("[OAuth] establishSession (web):", established);
          }
        ...
        if (sessionToken) {
          ...
          if (Platform.OS === "web") {
            const established = await Api.establishSession(sessionToken);
            console.log("[OAuth] establishSession from URL (web):", established);
          }
        ...
        if (result.sessionToken) {
          ...
          if (Platform.OS === "web") {
            ...
            console.log("[OAuth] establishSession after exchange (web):", established);
          }
